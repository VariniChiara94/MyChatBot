...
export function ChatbotPngIcon() {
    return (
        <Stack direction="row" spacing={0.2} alignItems="center" >
        <img
            src="/assets/icons8-chatbot-64.png"
            alt="Chatbot Icon"
            width={64}
            height={64}
        />
        <Typography variant={"h3"}
                    sx={{
                        background: "linear-gradient(90deg, #FF00FF, #00D3AB, #4876EE)",
                        backgroundClip: "text",
...
export function ChatbotPngShortIcon() {
    return (
...
export function ChatbotPngOnlyRobotIcon() {
    return (
        <Stack direction="row" spacing={2} alignItems="center" >
            <img
                src="/assets/icons8-chatbot-64.png"
